...
public class StudentCoursesData
{
    ...
    public string UserInitials { get; set; } = "ST";
    
    public List<MyCourseItem> AllCourses { get; set; } = new();
    public List<MyCourseItem> NotStartedCourses { get; set; } = new();
    ...
    public int NotStartedCount => NotStartedCourses.Count;
...
public class MyCourseItem
{
    ...
    public string Status { get; set; } = "NotStarted"; // Changed default
